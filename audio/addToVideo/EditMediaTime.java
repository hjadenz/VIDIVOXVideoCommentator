...
/** Edit media time lets the user take an audio file that has already been selected and added to the
 *  video, and change the position at which it is added to the video
 *  
 *  This position can be previewed in the position the audio wants it to be before adding it
 * 
...
public class EditMediaTime extends JFrame {
	...
	private void createLabels() {
		...
		// Labels that give the user the definite value that the audio will be placed at
	...
	/** Create the components that deal with the position the audio is being moved to */
	private void createTimePanel() {
		// Add a checkbox that lets the user decide whether they want to select a new time or use the 
		// video position (at the time that they opened the frame)
	 ...
	 *  These action listeners are responsible for creating previews and actually editing the 
	 *  media object
	 */
	private void createButtons() {
		...
		previewButton.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {	
				...
				CreatePreviewFile preview = new CreatePreviewFile(start.getOriginalVideoPath(), audio.getAudioPath(p), lf, start.getVideoTitle(), position, time);
