...
public class CreateNewAudio extends JFrame {
	...
	// Create the text pane which will hold the text the user inputs and wants to speak -----------------
	// Note that this text pane will have an enforced max character limit of 150 characters
	...
	private JLabel speedTitle = new JLabel("How fast would you like the speech?");
	...
	/** This method adds the text to the top of the frame that helps the user understand what they are
	 *  required to do
	 */
	...
	/** This method sets up the text field (and its limit) that the user inputs their text into */
