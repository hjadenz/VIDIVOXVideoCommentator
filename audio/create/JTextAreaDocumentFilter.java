...
public class JTextAreaDocumentFilter extends DocumentFilter {
	...
	// If the string to be inserted doesn't take the entire string over the character limit, insert the
	// characters as normal, otherwise do nothing
	@Override
	...
	// If the string to be replaced doesn't take the entire string over the character limit, replace the
	// characters as normal, otherwise do nothing
	@Override
