...
/** This class extends JPanel, but is a JPanel that is already set up with all its components
 *  It holds the components to change the volume for each different file in the selected video's list
 * 
...
public class VolumePanel extends JPanel {
	 ...
	 *  Make sure that the volume slider (when changed) can changed the volume component of the media object
	 */
