...
/**
 * This class is a type of slider that reacts to how long the video being played
 * is.
 * 
 * It holds its own information on the length of the video playing, as well as
 * the length of the audio that is being viewed (if applicable)
 * 
