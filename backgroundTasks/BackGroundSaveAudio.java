...
public BackgroundSaveAudio(String inputText, String filename, double speed, AddAudio audio){
...
protected Void doInBackground() throws Exception {
	...
	String cmd = "echo \"" + inputText + "\" | text2wave -o VIDIVOXmedia/" + filename + ".wav -eval \"(Parameter.set \'Duration_Stretch " + speed + ")\"";
...
/** This method lets the user know whether or not the audio file saved successfully */
protected void done(){
	...
	try {
		...
		if (process.exitValue() == 0) {
			...
			// If the audio was saved successfully give the name back, otherwise do nothing
			// Check whether the audio being saved has been called from the main frame or from an
			// AddAudio page (AddAudio will require a reference to the chosen audio's path sent back)
			if (audio != null) {
